...
const CineverseTestimonials = () => {
  ...
  return (
    <section className="relative w-full bg-[#EAE6DF] text-[#090706] overflow-hidden" style={{ paddingTop: '80px', paddingBottom: '150px' }}>
      <div className="w-full flex flex-col items-center">
        ...
        <div className="relative w-full flex overflow-hidden group">
          {/* Left/Right Fade Masks removed as requested */}
          ...
          >
            {duplicatedTestimonials.map((test, idx) => (
              <div
                key={idx}
                className="flex flex-col items-center justify-center text-center w-[350px] h-[350px] md:w-[450px] md:h-[450px] shrink-0 px-8 md:px-16 py-12 md:py-12 mx-4 bg-[#050505] rounded-md"
              >
                <div className="text-brand-red text-5xl md:text-6xl leading-none font-serif mb-6 opacity-40">"</div>
                <p className="text-lg md:text-xl font-light italic text-white leading-loose mb-8">
                  {test.quote}
                </p>
